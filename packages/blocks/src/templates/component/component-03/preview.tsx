...
export function Component03Preview({ block }: BlockTemplatePreviewProps) {
  const title = block.props.title ?? 'Component 03'

  return (
    <TemplateFrame block={block} className="randee-component-03" initScript={init}>
      <img
      ...
      <p className="randee-component-03__hint">Edit preview.tsx, style.css and script.js in Blocks</p>
    </TemplateFrame>
  )
}
