...
export function Component01Preview({ block }: BlockTemplatePreviewProps) {
  const title = block.props.title ?? 'Component 01'

  return (
    <TemplateFrame block={block} className="randee-component-01" initScript={init}>
      <img
